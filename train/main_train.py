...
parser.add_argument('--save_dir', default='../path_upgrade/dncnn_test_loss2', type=str, help='path of train data')
...
if __name__ == '__main__':
    ...
    for epoch in range(initial_epoch, n_epoch):
        ...
        for n_count, batch_yx in enumerate(DLoader):
            ...
            loss = criterion(output, batch_x, args.batch_size)
            loss_chk = cri_chk(output, batch_x)
            ...
            optimizer.step()
            if n_count % 10 == 0:
                print('%4d %4d / %4d loss_chk = %2.8f loss = %2.8f' % (
