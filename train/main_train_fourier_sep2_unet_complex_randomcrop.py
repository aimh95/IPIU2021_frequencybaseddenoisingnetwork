...
from model import Encoder1, NoBatchNorm, DnCNN, DecomposeNet, UNet, UNetDense
from loss import *
from utils import *
...
parser.add_argument('--save_dir', default='../path_upgrade/unet_complex2', type=str, help='path of train data')
...
if __name__ == '__main__':
    ...
    scheduler = MultiStepLR(optimizer, milestones=[700, 1400, 2100], gamma=0.2)  # learning rates
    for epoch in range(initial_epoch, n_epoch):
        ...
        for n_count, (batch_yx, label) in enumerate(trainloader):
            optimizer.zero_grad()
