...
parser.add_argument('--save_dir', default='../path_upgrade/frequency_sep2_dncnn_high2', type=str, help='path of train data')
...
if __name__ == '__main__':
    ...
    decompose_model = DnCNN(image_channels=2)
    ...
    for epoch in range(initial_epoch, n_epoch):
        ...
        for n_count, batch_yx in enumerate(DLoader):
            ...
            if n_count % 400 == 0:
                highfreq1.imshow(High_noise[0, 0].cpu(), cmap='rainbow')
                highfreq2.imshow(High_origin[0, 0].cpu(), cmap='rainbow')
                highfreq3.imshow(decompose_output[0,0].cpu().detach().numpy(), cmap='rainbow')
                lowfreq1.imshow(x_[0,0].cpu(), cmap='rainbow')
                lowfreq2.imshow(x_[0,1].cpu(), cmap='rainbow')
                lowfreq3.imshow(decompose_output[0,1].cpu().detach().numpy(), cmap='rainbow')
                plt.show()
                pass
