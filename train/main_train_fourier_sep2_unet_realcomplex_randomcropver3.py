...
from model import Encoder1, NoBatchNorm, UNetDenseFrequencyVer5
from loss import *
from utils import *
...
parser.add_argument('--save_dir', default='../path_upgrade/unet_realcomplex46', type=str, help='path of train data')
...
if __name__ == '__main__':
    ...
    model = UNetDenseFrequencyVer5(input_channels=1, image_channels=1)

    transform = transforms.Compose([transforms.RandomCrop(80),
                                    transforms.ToTensor()])
