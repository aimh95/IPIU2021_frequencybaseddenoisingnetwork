...
from model import Encoder1, NoBatchNorm, UNetDenseFrequencyVer42
from loss import *
from utils import *
...
parser.add_argument('--save_dir', default='../path_upgrade/unet_realcomplexsigma15_3', type=str, help='path of train data')
...
if __name__ == '__main__':
    ...
    model = UNetDenseFrequencyVer42(input_channels=3, image_channels=1)
    ...
    scheduler = MultiStepLR(optimizer, milestones=[1100, 1300, 1500], gamma=0.5)  # learning rates
    for epoch in range(initial_epoch, n_epoch):
        ...
        for n_count, (batch_yx, labels) in enumerate(trainloader):
            ...
            output = model(batch_y,Low_noise[:,:1], High_noise[:,:1])
