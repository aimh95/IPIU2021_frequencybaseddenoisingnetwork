...
from model import Encoder1, NoBatchNorm, UNetDenseFrequencyVer6, DnCNN
from loss import *
from utils import *
...
parser.add_argument('--save_dir', default='../path_upgrade/unet_realcomplex66', type=str, help='path of train data')
...
parser.add_argument('--lr', default=2.5e-5, type=float, help='initial learning rate for Adam')
...
if __name__ == '__main__':
    ...
    model = UNetDenseFrequencyVer6(input_channels=1, image_channels=1)
