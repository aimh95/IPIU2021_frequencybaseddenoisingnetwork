...
parser.add_argument('--save_dir', default='../path_upgrade/unet_realcomplex6', type=str, help='path of train data')
...
if __name__ == '__main__':
    ...
    model = UNetDenseFrequencyVer6(input_channels=3, image_channels=1)
    ...
    for epoch in range(initial_epoch, n_epoch):
        ...
        for n_count, batch_yx in enumerate(DLoader):
            ...
            if n_count % 10 == 0:
                ...
                epoch + 1, n_count, xs.size(0) // batch_size, chk_loss.item() / batch_size))
