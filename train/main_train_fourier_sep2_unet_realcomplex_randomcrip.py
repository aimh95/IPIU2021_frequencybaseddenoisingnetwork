...
from model import Encoder1, NoBatchNorm, UNetDenseFrequency
from loss import *
from utils import *
...
parser.add_argument('--save_dir', default='../path_upgrade/unet_realcomplex2', type=str, help='path of train data')
...
if __name__ == '__main__':
    ...
    scheduler = MultiStepLR(optimizer, milestones=[150, 200, 2100], gamma=0.2)  # learning rates
    for epoch in range(initial_epoch, n_epoch):
        ...
        for n_count, (batch_yx, labels) in enumerate(trainloader):
            ...
            output = model(batch_y, High_noise[:,:1], Low_noise[:,:1])
