...
from model import Encoder1, NoBatchNorm, UNetDenseFrequencyVer41
from loss import *
from utils import *
...
parser.add_argument('--save_dir', default='../path_upgrade/unet_realcomplexsigma50_2', type=str, help='path of train data')
...
if __name__ == '__main__':
    ...
    model = UNetDenseFrequencyVer41(input_channels=3, image_channels=1)
