...
parser.add_argument('--save_dir', default='../path_upgrade/unet_realcomplexsigma25_2', type=str, help='path of train data')
...
if __name__ == '__main__':
    ...
    scheduler = MultiStepLR(optimizer, milestones=[150, 300, 450], gamma=0.5)  # learning rates
