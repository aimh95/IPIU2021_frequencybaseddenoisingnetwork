...
def parse_args():
    ...
    # parser.add_argument('--model_name', default='model_082.pth', type=str, help='the model name')
    ...
    for set_cur in args.set_names:
        ...
        for im in os.listdir(os.path.join(args.set_dir, set_cur)):
            if im.endswith(".jpg") or im.endswith(".bmp") or im.endswith(".png"):
                ...
                output = ComplexTensor(dncnn_high[0,0] + decom_output[3], dncnn_high[0,1]+ decom_output[4]).abs()
