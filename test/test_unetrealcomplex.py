...
from model import Encoder1, DnCNN, Encoder2, NoBatchNorm, DecomposeNet, DecomposeNetLowFreq, UNetDenseFrequency
...
def parse_args():
    ...
    parser.add_argument('--model_dir', default=os.path.join('../path_upgrade/unet_realcomplex2'),
                        help='directory of the model')
    parser.add_argument('--model_name', default='model_152.pth', type=str, help='the model name')
...
if __name__ == '__main__':
    ...
    model = UNetDenseFrequency(input_channels=3, image_channels=1)
    ...
    for set_cur in args.set_names:
        ...
        for im in os.listdir(os.path.join(args.set_dir, set_cur)):
            if im.endswith(".jpg") or im.endswith(".bmp") or im.endswith(".png"):
                ...
                High_noise, Low_noise = Decomposition(torch.from_numpy(y), 0.125)
                ...
                x_ = model(y_, High_noise[:,:1], Low_noise[:,:1])
