...
if __name__ == '__main__':
    ...
    if not os.path.exists(os.path.join(args.model_dir, args.model_name)):
        ...
        decompose_model.load_state_dict(torch.load(os.path.join(args.model_dir, args.model_name)))
